...
from tickets.serializers import TicketSerializer, TicketInteracaoSerializer
from core.models import User, Attendant, Customer
...
class TicketRapidoService:
    ...
    def __init__(self, data, user: User):
        ...
        self.ticket = Ticket(
            ...
            versao=data.get('versao', cliente.clienteatualizacao_set.all().last().version),
    ...
    def get_totais(self):
        return (
            ...
            .aggregate(
                ...
                prioridade=Count('id', filter=~Q(status=Ticket.DEPLOYED) & Q(prioridade=Ticket.HIGH)),
            )
        )
