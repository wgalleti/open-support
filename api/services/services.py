...
from services.models import ServiceOrder, ServiceOrderItem, Service
...
class OrdemServicoService:
    ...
    def preparar_finalizacao(self, user):
        tecnicos = [dict(tecnico=t.tech.name,
                         tipo=t.service_type.description,
                         valor=t.value,
                         tempo=t.duration) for t in self.os.ordemservicotecnico_set.all()]
