...
class ServiceOrder(TimeModelMixin, UserModelMixin):
    ...
    closure_user = models.ForeignKey('core.User', on_delete=models.DO_NOTHING, null=True, blank=True, related_name='user_closure',)

    cancellation_date = models.DateField(null=True, blank=True)
    cancellation_user = models.ForeignKey('core.User', on_delete=models.DO_NOTHING, null=True, blank=True, related_name='user_cancellation')
    ...
    discount = models.DecimalField(max_digits=15, decimal_places=2, default=0, null=True, blank=True)
...
class ServiceOrderTech(TimeModelMixin, UserModelMixin):
    service_order = models.ForeignKey('services.ServiceOrder', on_delete=models.CASCADE)
    service_type = models.ForeignKey('services.ServiceType', on_delete=models.DO_NOTHING)
